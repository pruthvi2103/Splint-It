...
import { AuthButtons } from "../../shared/auth";
    ...
    <>
      ...
      <div className="w-full flex px-16 py-12 bg-gradient-to-r from-sky-700 text-white to-emerald-500">
        ...
        <div className="flex flex-col px-8 py-8  w-4/6 items-start justify-center">
          ...
          <h2 className="text-3xl font-bold mb-3 gray-100">
            MERN Stack Bootcamp
          </h2>
          <p className="w-10/12 flex-wrap text-base  text-gray-200">
            Learn complete web stack programming with React and Node by doing it
            the way a full-stack professional would do it. Learn how to create
            whole web apps from start to finish with one of the most trending
            tech stacks available. You can learn how to create data-driven
            applications, as well as how to test, protect, and deploy your code,
            in this thorough study path. This course necessitates a basic
      ...
      <div className="flex py-20 px-24 justify-between">
        ...
        <div className="w-2/6 ">
          ...
          <div className="flex flex-col bg-sky-50 py-8 rounded-3xl px-10">
            {/* price */}
            <p className="text-blue-800 text-2xl tracking-wide font-bold">
              {"₹7080.00"}
            </p>
            ...
            <p className="self-center text-sm ">
              This course is a part of Tech Neuron.
            </p>
            {/* Course Features */}
            <div>
              <p className="mt-5 mb-3 text-xl text-blue-800 font-semibold">
                Course Features
              </p>
              {courseFeatures.map((feature) => (
                <p
                  key={feature}
                  className="flex items-center justify-start mb-2 font-medium text-gray-600"
                >
                  {" "}
      ...
      <footer className="bg-gradient-to-r py-4 from from-blue-700 to-blue-600 flex items-center justify-between px-12">
        <p className="text-gray-200 opacity-60">
          © iNeuron Intelligence Pvt. Ltd. 2022
        </p>
        <p className="text-gray-200 opacity-60">
          Terms & Conditions <span className="text-orange-500">|</span> Privacy
          Policy
        </p>
      </footer>
    </>
